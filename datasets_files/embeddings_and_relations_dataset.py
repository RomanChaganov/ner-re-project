...
class EmbeddingsAndRelationsDataset(IterableDataset):
    ...
    INT_KEYS = ["relation_matrix", "entities_tags", "entities_positions", "row_coordinates"]
    ...
    def collate_function(self, batch: List[Dict[str, torch.Tensor]]) -> Dict[str, torch.Tensor]:
        ...
        key2item_shape = {"entities_embeddings": (1, 768), "entities_tags": (1), "entities_positions": (1, 2), "row_coordinates": (1)}
